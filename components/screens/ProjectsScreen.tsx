...
const TH =
  "px-2.5 py-2.5 text-start text-[13px] font-bold tracking-[0.05em] text-ink/90 border-b border-ink/20";
      ...
      <div>
        ...
        <table className="w-full border-collapse text-[15px]">
          ...
          <tbody>
              ...
              return (
                ...
                >
                  <td className={TD}>
                    ...
                    {p.kicker && (
                      <div className="text-[13px] text-ink/75">{p.kicker}</div>
                    )}
                  </td>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={6} className="px-2.5 py-10 text-center text-ink/70">
